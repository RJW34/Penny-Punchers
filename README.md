...
Production simulation is in src/StrikeLedger.Core, bots/replays/training/networking in src/StrikeLedger.App, and the native game and original vector/audio presentation in game. Canonical numeric data is under data. Tests use the production core and are separate from the initial Python arithmetic oracle.
